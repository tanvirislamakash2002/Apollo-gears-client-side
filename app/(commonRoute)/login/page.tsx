...
export default function LoginPage() {
    return (
        <main className="relative flex flex-1 items-center overflow-hidden bg-muted/30 px-4 py-12 sm:px-6 lg:px-8">
            <div className="pointer-events-none absolute inset-y-0 left-0 hidden w-1/2 bg-primary/[0.03] lg:block" />
            <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-[1fr_440px] lg:gap-20">
                <section className="hidden max-w-xl lg:block">
                    <p className="mb-5 text-sm font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                        Welcome back to Apollo Gears
                    </p>
                    ...
                    <p className="mt-6 max-w-md text-lg leading-8 text-muted-foreground">
                        Sign in to manage your bookings, follow active rentals, and keep every journey in reach.
                    </p>
                    <div className="mt-12 grid max-w-md grid-cols-3 gap-6 border-t border-border pt-6">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">Happy drivers</p>
                        </div>
                        <div>
